  ...
  myPlot.on("plotly_click", function(data) {
    ...
    switch (barClicked) {
      ...
      case 2: {
        ...
        for (var x = 0; x < imageData.length; x++) {
          if (
            imageData[x].properties.area > 50 &&
            imageData[x].properties.area < 100
          ) {
            areaSearchQ.push(imageData[x].properties.id);
          }
        }
      ...
      case 3: {
        ...
        for (var x = 0; x < imageData.length; x++) {
          if (
            imageData[x].properties.area > 100 &&
            imageData[x].properties.area < 150
          ) {
            areaSearchQ.push(imageData[x].properties.id);
          }
        }
      ...
      case 4: {
        ...
        for (var x = 0; x < imageData.length; x++) {
          if (
            imageData[x].properties.area > 150 &&
            imageData[x].properties.area < 200
          ) {
            areaSearchQ.push(imageData[x].properties.id);
          }
        }
      ...
      case 5: {
        ...
        for (var x = 0; x < imageData.length; x++) {
          if (
            imageData[x].properties.area > 200 &&
            imageData[x].properties.area < 250
          ) {
            areaSearchQ.push(imageData[x].properties.id);
          }
          break;
      ...
      case 6: {
        ...
        for (var x = 0; x < imageData.length; x++) {
          if (
            imageData[x].properties.area > 250 &&
            imageData[x].properties.area < 300
          ) {
            areaSearchQ.push(imageData[x].properties.id);
          }
          break;
